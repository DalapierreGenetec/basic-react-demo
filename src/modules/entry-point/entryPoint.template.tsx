...
export const EntryPointTemplate = (sidebarNavItems: SidebarNavItem[], topNavItems: TopNavItem[], currentNav?: TopNavigationType, currentSidebarNav?: SidebarNavItem) => (
    <div id="entry-point">
        <TopNav currentNav={currentNav} topNavItems={topNavItems}/>
        <div id="app-container">
            <Sidebar sidebarItems={sidebarNavItems} currentNavItem={currentSidebarNav} />
