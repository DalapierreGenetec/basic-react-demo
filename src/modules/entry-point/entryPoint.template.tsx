...
export const EntryPointTemplate = (sidebarNavItems: SidebarNavItem[], topNavItems: TopNavItem[],
                                   onTopNavClick: (topNav: TopNavigationType) => void,
                                   onSidebarNavClick: (sidebarNavItem: SidebarNavItem) => void,
                                   currentNav?: TopNavigationType, currentSidebarNav?: SidebarNavItem,
